...
const PRECACHE_URLS = [
  ...
  'js/image_quiz.js',
  'js/image_quiz.js?v=66',
  'js/cloud.js',
  'js/cloud.js?v=66',
  'js/ui.js',
  'js/ui.js?v=66',
  'data/cuestionario.csv',
  'data/cuestionario.csv?v=66',
  'data/cuestionario%20Burpleria.csv',
  'data/cuestionario%20Burpleria.csv?v=66',
  'data/cuestionario%20Primer%20Parcial%202026.csv',
  'data/cuestionario%20Primer%20Parcial%202026.csv?v=66',
  'data/image_questions.json',
  'data/image_questions.json?v=66'
];

...
const PRECACHE_URLS = [
  ...
  'js/image_quiz.js',
  'js/image_quiz.js?v=68',
  'js/cloud.js',
  'js/cloud.js?v=68',
  'js/ui.js',
  'js/ui.js?v=68',
  'data/cuestionario.csv',
  'data/cuestionario.csv?v=68',
  'data/cuestionario%20Burpleria.csv',
  'data/cuestionario%20Burpleria.csv?v=68',
  'data/cuestionario%20Primer%20Parcial%202026.csv',
  'data/cuestionario%20Primer%20Parcial%202026.csv?v=68',
  'data/image_questions.json',
  'data/image_questions.json?v=68'
];
